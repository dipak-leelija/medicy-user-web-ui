...
const PurchaseMaster = React.lazy(() => import("../pages/pharmacy/purchase-master"));
const AllTickets = React.lazy(() => import("../pages/pharmacy/allTickets"));
